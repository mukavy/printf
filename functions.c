 ...
 * @width: Width
 * @precision: Indicates Precision specification
 * @size: Indicates Size specifier
 ...
 * @width: To get width.
 * @precision: Show precision specification
 * @size: Indicate Size specifier
 * Return: If Number of characters is printed
 */
